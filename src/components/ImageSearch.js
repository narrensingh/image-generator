            ...
            <div className="relative w-80 min-w-[200px] h-10 m-auto mt-10 mb-10 flex items-end justify-center">
                <form className="w-full max-w-sm" onSubmit={search}>
                    <div className="flex items-center border-b border-purple-500 py-2">
                        <input className="appearance-none bg-transparent border-none w-full text-gray-700 mr-3 py-1 px-2 leading-tight focus:outline-none" type="text" placeholder="Search Image" aria-label="search" onChange={(e) => settext(e.currentTarget.value)}/>
